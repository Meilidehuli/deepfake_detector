class Logger:
    ...
    def print_logs_training(self):
        ...
        print("Which branch of the deepfake-detector to be trained: ", self.branch_selection)
        print("#------Status End-------#")
        print()
    ...
    def print_logs_evaluating(self):
        ...
        print("Directory of real samples: ", self.add_real)
        print("Directory of fake samples: ", self.add_fake)
        print("Which branch of the deepfake-detector to be evaluated: ", self.branch_selection)
        print("#------Status End-------#")
        print()
