...
def main(args):
    ...
    if branch_selection == 'g1' or branch_selection == 'all':
        g1 = deepfake-detector(**args_model)
    ...
    if branch_selection == 'g2' or branch_selection == 'all':
        g2 = deepfake-detector(**args_model)
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description='Evaluating codes of deepfake-detector (PyTorch version).',
    ...
    parser.add_argument('-b', '--branch', type=str,
                        choices=['g1', 'g2', 'all'],
                        default='all',
                        help="Select which branch of the deepfake-detector to be evaluated. "
